...
from spatracker_v1.datasets.utils import CoTrackerData
...
class DeepDeformDataset(CoTrackerDataset):
    def __init__(
        self,
        data_root,
        crop_size=(384, 512),
        ...
        super(DeepDeformDataset, self).__init__(
            data_root=data_root,
            crop_size=crop_size,
            seq_len=seq_len,
    ...
    def getitem_helper(self, index):
        ...
        rgb_path = os.path.join(self.data_root, seq_name, "color")
        depth_path = os.path.join(self.data_root, seq_name, "depth")
